...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\Lenovo\\Documents\\Estudos\\TI\\Rocketseat\\devops\\desafio-II\\my-ecommerce\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\Lenovo\\Documents\\Estudos\\TI\\Rocketseat\\devops\\desafio-II\\my-ecommerce\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgres://api_commerce:sup3rs3c&t@localhost:5432/my-ecommerce"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider      = \"prisma-client-js\"\n  output        = \"../generated/prisma\"\n  binaryTargets = [\"native\", \"linux-musl-openssl-3.0.x\"]\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Customer {\n  id        String    @id @default(uuid())\n  name      String\n  email     String    @unique\n  password  String\n  createdAt DateTime  @default(now()) @map(\"created_at\")\n  updatedAt DateTime? @updatedAt @map(\"updated_at\")\n}\n",
  "inlineSchemaHash": "f7aa3b17404d7ddaf343daceba29adbff4c3ecc8df5a3121653514af24590928",
  "copyEngine": true
}
config.dirname = '/'
